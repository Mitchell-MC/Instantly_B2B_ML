"""
Improved 2-Bucket XGBoost Model: Opening vs Not Opening
...
Incorporates better feature engineering and preprocessing from the older script.
"""
...
# --- Configuration ---
CSV_FILE_PATH = Path("merged_contacts_comprehensive_cleaned_v2.csv")
...
def load_and_preprocess_data():
    """Load data and create binary target variable with enhanced feature engineering."""
...
def main():
    """Main function for binary classification with improved preprocessing."""
    print("=== IMPROVED 2-BUCKET XGBOOST: OPENING PREDICTION ===")
    ...
    plt.title('Feature Importances - Improved 2-Bucket XGBoost\n(Opening vs Not Opening Prediction)')
    plt.tight_layout()
    plt.savefig('2_bucket_xgboost_feature_importance_improved.png', dpi=300, bbox_inches='tight')
    print(f"\nFeature importance plot saved as '2_bucket_xgboost_feature_importance_improved.png'")
    plt.show()
    ...
    plt.title('Confusion Matrix - Improved 2-Bucket XGBoost\nOpening Prediction')
    plt.ylabel('Actual')
    plt.xlabel('Predicted')
    plt.tight_layout()
    plt.savefig('2_bucket_xgboost_confusion_matrix_improved.png', dpi=300, bbox_inches='tight')
    print(f"Confusion matrix saved as '2_bucket_xgboost_confusion_matrix_improved.png'")
    plt.show()
